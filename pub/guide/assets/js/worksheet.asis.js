...
if (location.host == 'd-app.sbisb.co.kr' || location.host == 'd-www.sbisb.co.kr' || location.host =='d-adm.sbisb.co.kr') {
  $headerHtml += '<li><a href="https://d-app.sbisb.co.kr/pub/guide/html/worksheet.html" target="_blank">App</a></li>';
} else {  
...
if (location.host == 'd-www.sbisb.co.kr' || location.host == 'd-app.sbisb.co.kr' || location.host == 'd-adm.sbisb.co.kr') {
  $headerHtml += '<li><a href="https://d-www.sbisb.co.kr/pub/SBP/guide/html/worksheet.html" target="_blank">PC</a></li>';
} else {  
  $headerHtml += '<li><a href="/pub/guide/html/worksheet.html" target="_blank">PC</a></li>';
}
if (location.host == 'd-adm.sbisb.co.kr' || location.host == 'd-www.sbisb.co.kr' || location.host == 'd-app.sbisb.co.kr') {
  ...
  $headerHtml += '<li><a href="/pub/guide/html/worksheet.html" target="_blank">Admin</a></li>';
}
$headerHtml += '</ul>';
$headerHtml += '</div>';
        ...
        if (obj.id) {
          if (obj.link) {
            ...
            if(obj.id.indexOf('CMM') > -1) {
              trHtml += '<td class="id"><a href="' + '/pub/html/CMM/' + obj.id + '.html" target="_blank">' + obj.id + '</a></td>';
            } else {
