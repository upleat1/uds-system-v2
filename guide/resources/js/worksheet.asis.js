...
$headerHtml += '<ul>';
$headerHtml += '<li><a href="/guide/html/worksheet.html" target="_blank">Worksheet</a></li>';
$headerHtml += '<li><a href="/guide/html/guide.html" target="_blank">Guide</a></li>';
$headerHtml += '<li><a href="/guide/html/document.html" target="_blank">Document</a></li>';
$headerHtml += '</ul>';
$headerHtml += '</div>';
...
if (location.host == 'd-app.sbisb.co.kr' || location.host == 'd-www.sbisb.co.kr' || location.host =='d-adm.sbisb.co.kr') {
  $headerHtml += '<li><a href="https://d-app.sbisb.co.kr/guide/html/worksheet.html" target="_blank">App</a></li>';
} else {  
  $headerHtml += '<li><a href="/guide/html/worksheet.html" target="_blank">App</a></li>';
}
if (location.host == 'd-www.sbisb.co.kr' || location.host == 'd-app.sbisb.co.kr' || location.host == 'd-adm.sbisb.co.kr') {
  $headerHtml += '<li><a href="https://d-www.sbisb.co.kr/SBP/guide/html/worksheet.html" target="_blank">PC</a></li>';
} else {  
  $headerHtml += '<li><a href="/guide/html/worksheet.html" target="_blank">PC</a></li>';
}
if (location.host == 'd-adm.sbisb.co.kr' || location.host == 'd-www.sbisb.co.kr' || location.host == 'd-app.sbisb.co.kr') {
  $headerHtml += '<li><a href="http://d-adm.sbisb.co.kr/guide/html/worksheet.html" target="_blank">Admin</a></li>';
} else {  
  $headerHtml += '<li><a href="/guide/html/worksheet.html" target="_blank">Admin</a></li>';
}
$headerHtml += '</ul>';
$headerHtml += '</div>';
      ...
      if (obj.directory !== undefined && obj.directory !== '') {
        ...
        if (obj.id) {
          if (obj.link) {
            ...
            if(obj.id.indexOf('CMM') > -1) {
              trHtml += '<td class="id"><a href="' + '/html/CMM/' + obj.id + '.html" target="_blank">' + obj.id + '</a></td>';
            } else {
        ...
        if (obj.complete && obj.state == undefined) {
          ...
          trHtml += '<td class="complete"><span class="ing">대기중</span></td>';
        } else {
...
var guide = {
  ...
  tab: function () {
    ...
    var $tabCurrent = $('.g_board_tab ul li.active');
    var $panel = $('.g_board_panel');
  ...
  board: function () {
    ...
    $('.g_board').each(function () {
      ...
      $(this)
        ...
        .each(function () {
          var _txt6 = $(this).text();
          if (!!_txt6) {
            $(this).closest('tr').addClass(_txt6);
    ...
    $('.g_board thead th select').change(function () {
      ...
      var $pVal = $thead.find('.complete select').val();
      var $tbody = $(this).closest('.g_board').find('tbody');
      if ($cVal == '' && $mVal == '' && $wVal == '' && $pVal == '') {
        $tbody.find('tr').removeAttr('style');
      } else if ($cVal != '' && $mVal != ''&& $wVal != ''&& $pVal != '') {
        $tbody.find('tr').not('.hr').hide();
        $tbody.find('.c_' + $cVal + '.m_' + $mVal + $wVal + $pVal).show();
      } else {
        $tbody.find('tr').not('.hr').hide();
    ...
    $('.g_board_panel').each(function () {
      ...
      var ingNum = function () {
        ...
        $this.find('tbody tr.working').each(function () {
          ...
          if (!$(this).hasClass('del') && $(this).find('td.complete').text() === '검수중') length += 1;
        });
        return length;
      };
  ...
  UI: function () {
    ...
    $(document).on('mouseover', 'td a.btn_hover', function (e) {
      var //url = $(this).attr('href'),
          url = $(this).parent().siblings('.id').children('a').attr('href'),
